...
export default function DirCrmStatuses() {
  const formDataContent = { Id: "", Name: "", Comment: "" }; // ДОКУМЕНТ

  const API = {
    List: "crm_status_list",
    Archive: "archive_crm_status_list",
    Add: "add_dir_crm_status",
    Edit: "edit_dir_crm_status",
    Delete: "delete_dir_crm_status",
    Recover: "recover_dir_crm_status",
  };
